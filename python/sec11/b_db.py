...
# my 임포트 시 위 4줄 가리기 인트 타입이니까 그런 듯?
'''
Traceback (most recent call last):
  File "C:\pywork\Project32\sec11\b_db.py", line 36, in <module>
    row = cur.fetchone()
          ^^^^^^^^^^^^^^
  File "C:\pywork\Project32\sec11\my.py", line 35, in convert_timestamp
    return datetime.datetime.fromtimestamp(int(val))
                                           ^^^^^^^^
ValueError: invalid literal for int() with base 10: b'2024-01-02 02:56:53'
'''
con.close()